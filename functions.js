...
function makeASandwich(breadType, sandwichName, isToasted){
  var finishedSandwich = `You ordered a ${isToasted} ${sandwichName} on ${breadType}.`
  return finishedSandwich;
}
var yourSandwich = makeASandwich("wheat", "meatball sub", "toasted");
console.log(yourSandwich);
